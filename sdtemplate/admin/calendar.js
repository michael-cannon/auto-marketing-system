...
var dateSetConvert = dateSet + 7;
var dateSetEnd = dateSet + 9;
...
var yc = dateToSetConvert.getYear(); if(yc.length == 2) yc += 1900;
...
var ye = dateToSetEnd.getYear(); if(ye.length == 2) yc += 1900;
var dend = me + ' ' + de + ' ' + ye;
