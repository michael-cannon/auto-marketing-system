<?php
class Admin_listing extends Admin_site
{
    function Admin_listing($db, $product_configuration=0)
    {
        //constructor
    ...
    function listing_home($db)
    {
        ...
        $this->body .= "<strong>Auctions Reports</strong><hr size=1 color=#ff9900 width = 100% align=left>";
        ...
        $this->body .= "<strong>Classifieds Reports</strong><hr size=1 color=#ff9900 align=left width=100%>";
        $this->body .= "<table width=50% align=center cellspacing=0 cellpadding=3>\n<tr>\n\t<td align=left>\n\t<ul>";
        $this->body .= "<li type=square><a href=index.php?a=300&b=21&c=1><span class=medium_font><font color=000000>Show Closed Classifieds Report</span></a></li>\n";
        $this->body .= "<li type=square><a href=index.php?a=300&b=22&c=1><span class=medium_font><font color=000000>Show Open Classifieds Report</span></a></li>\n";
        $this->body .= "<li type=square><a href=index.php?a=300&b=21&c=2><span class=medium_font><font color=000000>Download Closed Classifieds Report</span></a></li>\n";
        $this->body .= "<li type=square><a href=index.php?a=300&b=22&c=2><span class=medium_font><font color=000000>Download Open Classifieds Report</span></a></li>\n";
        $this->body .= "</ul>\n</td\n></tr>\n</table>\n";
    ...
    function show_open_classifieds_report($db)
    {
        ...
        if($recordCount > 0)
        {
            $this->body .= "<span class=medium_font><a href=index.php?a=300&b=1&c=2>Download Open Classifieds Report</a></span><p>";
            $this->body .= '<table width = 100% cellpadding=3 cellspacing=1 class=row_color_red>';
            $this->body .= "<tr bgcolor=#000099>";
