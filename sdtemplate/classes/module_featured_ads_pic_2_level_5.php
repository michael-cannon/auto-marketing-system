...
$this->sql_query = "select * from geodesic_classifieds where featured_ad_5 = 1 and image > 0 and live = 1 ".$this->sql_zip_filter_in_statement.$this->sql_state_filter_statement.$sql_filter_in_statement.$type_in_statement;
...
elseif ($featured_result->RecordCount() > 0)
{
	...
	if ($featured_result->RecordCount() > 0)
	{
		...
		if ($show_module['module_display_header_row'])
			$this->body .="<tr class=featured_ad_pics_2_header_row_level_5><td colspan=".$show_module['module_number_of_columns'].">
				".urldecode($this->messages[2259])."</td></tr>\n\t";
		...
		while ($show = $featured_result->FetchRow())
		{
			...
			{
				$this->body .="<tr class=featured_ad_pics_1_pic_row_level_5><td width=".$column_width." valign=top>";
				...
				{
					$this->body .= "</td></tr>";
					$this->body .= "<tr><td class=featured_ad_pics_1_pic_row_level_5>";
				}
				...
				if($this->is_class_auctions())
				{
					...
					{
						$this->body .= "<br>";
						$this->body .= urldecode($this->messages[200047]);
					...
					{
						$this->body .= "<br>";
						$this->body .= urldecode($this->messages[200048]);
