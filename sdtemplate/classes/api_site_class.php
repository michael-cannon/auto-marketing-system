...
//%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	...
	function API_site ()
	{
		...
		// MLC 20070814 kill globals if possible
		global $api_db_host;
		global $api_db_username;
		global $api_db_password;
		global $api_database;
		global $db_host;
		global $database;
...
//%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	...
	function send_admin_error_email()
	{
        ...
        mail("michael@peimic.com","api registration error",$this->error_message,$from,$additional);
