...
elseif ($featured_result->RecordCount() > 0)
{
	...
	//$result->Move(0);
	//$this->display_featured_2_level_5_result($db,$featured_result);
	if ($featured_result->RecordCount() > 0)
	{
		...
		{
			$this->body .="<tr class=featured_2_level_5_title_row>\n\t\t";
			$colspan = 1;
			...
			if ($show_module['module_display_time_left'])
				$colspan++;
			$this->body .= "<td colspan=".$colspan.">".urldecode($this->messages[2345])."</td>\n";
			$this->body .="</tr>\n\t";
		}
		$this->body .="<tr>\n\t\t";
		if ($show_module['module_display_header_row'])
		{
			...
			if ($show_module['module_display_listing_column'])
			{
				$this->body .="<td class=featured_2_level_5_type nowrap>".urldecode($this->messages[200094])."</td>\n\t";
			}

			if ($show_module['module_display_photo_icon'])
			{
				$this->body .="<td  class=featured_2_level_5_photo_td nowrap>".urldecode($this->messages[2315])."</td>\n\t";
			}
			// 0 is default condition
			if (!$show_module['module_display_title'])
			{
				$this->body .="<td  class=featured_2_level_5_title_td ";
				if ((($show_module['module_display_ad_description'])&& ($show_module['module_display_ad_description_where'])) || (!$show_module['module_display_ad_description']))
					$this->body .= "width=100%";				
				$this->body .=">".urldecode($this->messages[2314]);
				if (($show_module['module_display_ad_description']) && ($show_module['module_display_ad_description_where']))
				{
					$this->body .="<br>".urldecode($this->messages[2316]);
				}
				$this->body .="</td>\n\t\t";
			}
			if (($show_module['module_display_ad_description']) && (!$show_module['module_display_ad_description_where']))
			{
				$this->body .="<td   class=featured_2_level_5_description_td>".urldecode($this->messages[2316])."</td>\n\t";
			}
			if ($show_module['module_display_optional_field_1'])
				$this->body .="<td   class=featured_2_level_5_optional_header_1 nowrap>".urldecode($this->messages[2317])."</font></td>\n\t";
			if ($show_module['module_display_optional_field_2'])
				$this->body .="<td   class=featured_2_level_5_optional_header_2 nowrap>".urldecode($this->messages[2318])."</font></td>\n\t";
			if ($show_module['module_display_optional_field_3'])
				$this->body .="<td   class=featured_2_level_5_optional_header_3 nowrap>".urldecode($this->messages[2319])."</font></td>\n\t";
			if ($show_module['module_display_optional_field_4'])
				$this->body .="<td   class=featured_2_level_5_optional_header_4 nowrap>".urldecode($this->messages[2320])."</font></td>\n\t";
			if ($show_module['module_display_optional_field_5'])
				$this->body .="<td   class=featured_2_level_5_optional_header_5 nowrap>".urldecode($this->messages[2321])."</font></td>\n\t";
			if ($show_module['module_display_optional_field_6'])
				$this->body .="<td   class=featured_2_level_5_optional_header_6 nowrap>".urldecode($this->messages[2322])."</font></td>\n\t";
			if ($show_module['module_display_optional_field_7'])
				$this->body .="<td   class=featured_2_level_5_optional_header_7 nowrap>".urldecode($this->messages[2323])."</font></td>\n\t";
			if ($show_module['module_display_optional_field_8'])
				$this->body .="<td   class=featured_2_level_5_optional_header_8 nowrap>".urldecode($this->messages[2324])."</font></td>\n\t";
			if ($show_module['module_display_optional_field_9'])
				$this->body .="<td   class=featured_2_level_5_optional_header_9 nowrap>".urldecode($this->messages[2325])."</font></td>\n\t";
			if ($show_module['module_display_optional_field_10'])
				$this->body .="<td   class=featured_2_level_5_optional_header_10 nowrap>".urldecode($this->messages[2326])."</font></td>\n\t";
			if ($show_module['module_display_optional_field_11'])
				$this->body .="<td   class=featured_2_level_5_optional_header_11 nowrap>".urldecode($this->messages[2327])."</font></td>\n\t";
			if ($show_module['module_display_optional_field_12'])
				$this->body .="<td   class=featured_2_level_5_optional_header_12 nowrap>".urldecode($this->messages[2328])."</font></td>\n\t";
			if ($show_module['module_display_optional_field_13'])
				$this->body .="<td   class=featured_2_level_5_optional_header_13 nowrap>".urldecode($this->messages[2329])."</font></td>\n\t";
			if ($show_module['module_display_optional_field_14'])
				$this->body .="<td   class=featured_2_level_5_optional_header_14 nowrap>".urldecode($this->messages[2330])."</font></td>\n\t";
			if ($show_module['module_display_optional_field_15'])
				$this->body .="<td   class=featured_2_level_5_optional_header_15 nowrap>".urldecode($this->messages[2331])."</font></td>\n\t";
			if ($show_module['module_display_optional_field_16'])
				$this->body .="<td   class=featured_2_level_5_optional_header_16 nowrap>".urldecode($this->messages[2332])."</font></td>\n\t";
			if ($show_module['module_display_optional_field_17'])
				$this->body .="<td   class=featured_2_level_5_optional_header_17 nowrap>".urldecode($this->messages[2333])."</font></td>\n\t";
			if ($show_module['module_display_optional_field_18'])
				$this->body .="<td   class=featured_2_level_5_optional_header_18 nowrap>".urldecode($this->messages[2334])."</font></td>\n\t";
			if ($show_module['module_display_optional_field_19'])
				$this->body .="<td   class=featured_2_level_5_optional_header_19 nowrap>".urldecode($this->messages[2335])."</font></td>\n\t";
			if ($show_module['module_display_optional_field_20'])
				$this->body .="<td   class=featured_2_level_5_optional_header_20 nowrap>".urldecode($this->messages[2336])."</font></td>\n\t";
			if ($show_module['module_display_city'])
				$this->body .="<td  class=featured_2_level_5_city_header nowrap>".urldecode($this->messages[2337])."</td>\n\t";
			if ($show_module['module_display_state'])
				$this->body .="<td class=featured_2_level_5_state_header nowrap>".urldecode($this->messages[2338])."</td>\n\t";
			if ($show_module['module_display_country'])
				$this->body .="<td class=featured_2_level_5_country_header nowrap>".urldecode($this->messages[2339])."</td>\n\t";
			if ($show_module['module_display_zip'])
				$this->body .="<td class=featured_2_level_5_zip_header nowrap>".urldecode($this->messages[2340])."</td>\n\t";

			//CLASSAUCTIONS and AUCTIONS SPECIFIC
			if ($show_module['module_display_number_bids'])
			{
				$this->body .="<td class=featured_2_level_5_number_bids nowrap>".urldecode($this->messages[102667])."</td>\n\t";
			}

			if ($show_module['module_display_price'])
				$this->body .="<td  class=featured_2_level_5_price_td  nowrap>".urldecode($this->messages[2341])."</td>\n\t";
			if ($show_module['module_display_entry_date'])
				$this->body .="<td  class=featured_2_level_5_entry_td nowrap>".urldecode($this->messages[2342])."</td>\n\t";

			//CLASSAUCTIONS and AUCTIONS SPECIFIC
			if ($show_module['module_display_time_left'])
			{
				$this->body .="<td class=featured_2_level_5_time_left nowrap>".urldecode($this->messages[102668])."</td>\n\t";
			}
		...
		while ($show_classifieds = $featured_result->FetchRow())
		{
			if (($this->row_count % 2) == 0)
			{
				if ($show_classifieds['bolding'])
					$css_class_tag= "featured_2_level_5_result_table_body_even_bold";
				else
					$css_class_tag=  "featured_2_level_5_result_table_body_even ";
			}
			else
			{
				if ($show_classifieds['bolding'])
					$css_class_tag=  "featured_2_level_5_result_table_body_odd_bold";
				else
					$css_class_tag=  "featured_2_level_5_result_table_body_odd ";
			}
			...
			*/
			...
			if ($show_module['module_display_time_left'])
			{
				...
				if ($weeks > 0)
				{
					$this->body .= $weeks." ".stripslashes(urldecode($this->messages[102669])).", ".$days." ".stripslashes(urldecode($this->messages[102670]));
				}
				elseif ($days > 0)
				{
					$this->body .= $days." ".stripslashes(urldecode($this->messages[102670])).", ".$hours." ".stripslashes(urldecode($this->messages[102671]));
				}
				elseif ($hours > 0)
				{
					$this->body .= $hours." ".stripslashes(urldecode($this->messages[102671])).", ".$minutes." ".stripslashes(urldecode($this->messages[102672]));
				}
				elseif ($minutes > 0)
				{
					$this->body .= $minutes." ".stripslashes(urldecode($this->messages[102672])).", ".$seconds." ".stripslashes(urldecode($this->messages[102673]));
				}
				elseif ($seconds > 0)
				{
					$this->body .= $seconds." ".stripslashes(urldecode($this->messages[102673]));
				}
