...
elseif ($featured_result->RecordCount() > 0)
{
	...
	//$result->Move(0);
	//$this->display_featured_2_level_2_result($db,$featured_result);
	if ($featured_result->RecordCount() > 0)
	{
		...
		{
			$this->body .="<tr class=featured_2_level_2_title_row>\n\t\t";
			$colspan = 1;
			...
			if ($show_module['module_display_time_left'])
				$colspan++;
			$this->body .= "<td colspan=".$colspan.">".urldecode($this->messages[2013])."</td>\n";
			$this->body .="</tr>\n\t";
		}
		$this->body .="<tr>\n\t\t";
		if ($show_module['module_display_header_row'])
		{
			...
			if ($show_module['module_display_listing_column'])
			{
				$this->body .="<td class=featured_2_level_2_type nowrap>".urldecode($this->messages[200073])."</td>\n\t";
			}

			if ($show_module['module_display_photo_icon'])
			{
				$this->body .="<td  class=featured_2_level_2_photo_td nowrap>".urldecode($this->messages[2014])."</td>\n\t";
			}
			// 0 is default condition
			if (!$show_module['module_display_title'])
			{
				$this->body .="<td  class=featured_2_level_2_title_td ";
				if ((($show_module['module_display_ad_description'])&& ($show_module['module_display_ad_description_where'])) || (!$show_module['module_display_ad_description']))
					$this->body .= "width=100%";					
				$this->body .=">".urldecode($this->messages[2015]);
				if (($show_module['module_display_ad_description']) && ($show_module['module_display_ad_description_where']))
				{
					$this->body .="<br>".urldecode($this->messages[2016]);
				}
				$this->body .="</td>\n\t\t";
			}
			if (($show_module['module_display_ad_description']) && (!$show_module['module_display_ad_description_where']))
			{
				$this->body .="<td   class=featured_2_level_2_description_td>".urldecode($this->messages[2016])."</td>\n\t";
			}
			if ($show_module['module_display_optional_field_1'])
				$this->body .="<td   class=featured_2_level_2_optional_header_1 nowrap>".urldecode($this->messages[2019])."</font></td>\n\t";
			if ($show_module['module_display_optional_field_2'])
				$this->body .="<td   class=featured_2_level_2_optional_header_2 nowrap>".urldecode($this->messages[2020])."</font></td>\n\t";
			if ($show_module['module_display_optional_field_3'])
				$this->body .="<td   class=featured_2_level_2_optional_header_3 nowrap>".urldecode($this->messages[2021])."</font></td>\n\t";
			if ($show_module['module_display_optional_field_4'])
				$this->body .="<td   class=featured_2_level_2_optional_header_4 nowrap>".urldecode($this->messages[2022])."</font></td>\n\t";
			if ($show_module['module_display_optional_field_5'])
				$this->body .="<td   class=featured_2_level_2_optional_header_5 nowrap>".urldecode($this->messages[2022])."</font></td>\n\t";
			if ($show_module['module_display_optional_field_6'])
				$this->body .="<td   class=featured_2_level_2_optional_header_6 nowrap>".urldecode($this->messages[2023])."</font></td>\n\t";
			if ($show_module['module_display_optional_field_7'])
				$this->body .="<td   class=featured_2_level_2_optional_header_7 nowrap>".urldecode($this->messages[2024])."</font></td>\n\t";
			if ($show_module['module_display_optional_field_8'])
				$this->body .="<td   class=featured_2_level_2_optional_header_8 nowrap>".urldecode($this->messages[2025])."</font></td>\n\t";
			if ($show_module['module_display_optional_field_9'])
				$this->body .="<td   class=featured_2_level_2_optional_header_9 nowrap>".urldecode($this->messages[2026])."</font></td>\n\t";
			if ($show_module['module_display_optional_field_10'])
				$this->body .="<td   class=featured_2_level_2_optional_header_10 nowrap>".urldecode($this->messages[2027])."</font></td>\n\t";
			if ($show_module['module_display_optional_field_11'])
				$this->body .="<td   class=featured_2_level_2_optional_header_11 nowrap>".urldecode($this->messages[2028])."</font></td>\n\t";
			if ($show_module['module_display_optional_field_12'])
				$this->body .="<td   class=featured_2_level_2_optional_header_12 nowrap>".urldecode($this->messages[2029])."</font></td>\n\t";
			if ($show_module['module_display_optional_field_13'])
				$this->body .="<td   class=featured_2_level_2_optional_header_13 nowrap>".urldecode($this->messages[2030])."</font></td>\n\t";
			if ($show_module['module_display_optional_field_14'])
				$this->body .="<td   class=featured_2_level_2_optional_header_14 nowrap>".urldecode($this->messages[2031])."</font></td>\n\t";
			if ($show_module['module_display_optional_field_15'])
				$this->body .="<td   class=featured_2_level_2_optional_header_15 nowrap>".urldecode($this->messages[2032])."</font></td>\n\t";
			if ($show_module['module_display_optional_field_16'])
				$this->body .="<td   class=featured_2_level_2_optional_header_16 nowrap>".urldecode($this->messages[2033])."</font></td>\n\t";
			if ($show_module['module_display_optional_field_17'])
				$this->body .="<td   class=featured_2_level_2_optional_header_17 nowrap>".urldecode($this->messages[2034])."</font></td>\n\t";
			if ($show_module['module_display_optional_field_18'])
				$this->body .="<td   class=featured_2_level_2_optional_header_18 nowrap>".urldecode($this->messages[2035])."</font></td>\n\t";
			if ($show_module['module_display_optional_field_19'])
				$this->body .="<td   class=featured_2_level_2_optional_header_19 nowrap>".urldecode($this->messages[2036])."</font></td>\n\t";
			if ($show_module['module_display_optional_field_20'])
				$this->body .="<td   class=featured_2_level_2_optional_header_20 nowrap>".urldecode($this->messages[2037])."</font></td>\n\t";
			if ($show_module['module_display_city'])
				$this->body .="<td  class=featured_2_level_2_city_header nowrap>".urldecode($this->messages[2038])."</td>\n\t";
			if ($show_module['module_display_state'])
				$this->body .="<td class=featured_2_level_2_state_header nowrap>".urldecode($this->messages[2039])."</td>\n\t";
			if ($show_module['module_display_country'])
				$this->body .="<td class=featured_2_level_2_country_header nowrap>".urldecode($this->messages[2040])."</td>\n\t";
			if ($show_module['module_display_zip'])
				$this->body .="<td class=featured_2_level_2_zip_header nowrap>".urldecode($this->messages[2041])."</td>\n\t";

			//CLASSAUCTIONS and AUCTIONS SPECIFIC
			if ($show_module['module_display_number_bids'])
			{
				$this->body .="<td class=featured_2_level_2_number_bids nowrap>".urldecode($this->messages[102632])."</td>\n\t";
			}

			if ($show_module['module_display_price'])
				$this->body .="<td  class=featured_2_level_2_price_td  nowrap>".urldecode($this->messages[2017])."</td>\n\t";
			if ($show_module['module_display_entry_date'])
				$this->body .="<td  class=featured_2_level_2_entry_td nowrap>".urldecode($this->messages[2018])."</td>\n\t";

			//CLASSAUCTIONS and AUCTIONS SPECIFIC
			if ($show_module['module_display_time_left'])
			{
				$this->body .="<td class=featured_2_level_2_time_left nowrap>".urldecode($this->messages[102633])."</td>\n\t";
			}
		...
		while ($show_classifieds = $featured_result->FetchRow())
		{
			if (($this->row_count % 2) == 0)
			{
				if ($show_classifieds['bolding'])
					$css_class_tag= "featured_2_level_2_result_table_body_even_bold";
				else
					$css_class_tag=  "featured_2_level_2_result_table_body_even ";
			}
			else
			{
				if ($show_classifieds['bolding'])
					$css_class_tag=  "featured_2_level_2_result_table_body_odd_bold";
				else
					$css_class_tag=  "featured_2_level_2_result_table_body_odd ";
			}
			...
			if ($show_module['module_display_listing_column'])
			{
				...
				{
					$this->body .=urldecode($this->messages[200074]);
				}
				if ($show_classifieds['item_type'] == 2)
				{
					$this->body .=urldecode($this->messages[200075]);
				}
			...
			*/
			...
			if ($show_module['module_display_time_left'])
			{
				...
				if ($weeks > 0)
				{
					$this->body .= $weeks." ".stripslashes(urldecode($this->messages[102634])).", ".$days." ".stripslashes(urldecode($this->messages[102635]));
				}
				elseif ($days > 0)
				{
					$this->body .= $days." ".stripslashes(urldecode($this->messages[102635])).", ".$hours." ".stripslashes(urldecode($this->messages[102636]));
				}
				elseif ($hours > 0)
				{
					$this->body .= $hours." ".stripslashes(urldecode($this->messages[102636])).", ".$minutes." ".stripslashes(urldecode($this->messages[102637]));
				}
				elseif ($minutes > 0)
				{
					$this->body .= $minutes." ".stripslashes(urldecode($this->messages[102637])).", ".$seconds." ".stripslashes(urldecode($this->messages[102638]));
				}
				elseif ($seconds > 0)
				{
					$this->body .= $seconds." ".stripslashes(urldecode($this->messages[102638]));
				}
