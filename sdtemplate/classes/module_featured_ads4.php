...
elseif ($featured_result->RecordCount() > 0)
{
	...
	//$result->Move(0);
	//$this->display_featured_4_result($db,$featured_result);
	if ($featured_result->RecordCount() > 0)
	{
		...
		{
			$this->body .="<tr class=featured_4_title_row>\n\t\t";
			$colspan = 1;
			...
			if ($show_module['module_display_time_left'])
				$colspan++;
			$this->body .= "<td colspan=".$colspan.">".urldecode($this->messages[699])."</td>\n";
			$this->body .="</tr>\n\t";
		}
		$this->body .="<tr>\n\t\t";
		if ($show_module['module_display_header_row'])
		{
			...
			if ($show_module['module_display_listing_column'])
			{
				$this->body .="<td class=featured_4_type nowrap>".urldecode($this->messages[200058])."</td>\n\t";
			}
			if ($show_module['module_display_photo_icon'])
			{
				$this->body .="<td  class=featured_4_photo_td nowrap>".urldecode($this->messages[694])."</td>\n\t";
			}
			// 0 is default condition
			if (!$show_module['module_display_title'])
			{
				$this->body .="<td  class=featured_4_title_td ";
				if ((($show_module['module_display_ad_description'])&& ($show_module['module_display_ad_description_where'])) || (!$show_module['module_display_ad_description']))
					$this->body .= "width=100%";				
				$this->body .=">".urldecode($this->messages[695]);
				if (($show_module['module_display_ad_description']) && ($show_module['module_display_ad_description_where']))
				{
					$this->body .="<br>".urldecode($this->messages[696]);
				}
				$this->body .="</td>\n\t\t";
			}
			if (($show_module['module_display_ad_description']) && (!$show_module['module_display_ad_description_where']))
			{
				$this->body .="<td   class=featured_4_description_td>".urldecode($this->messages[696])."</td>\n\t";
			}
			if ($show_module['module_display_optional_field_1'])
				$this->body .="<td   class=featured_4_optional_header_1 nowrap>".urldecode($this->messages[1009])."</font></td>\n\t";
			if ($show_module['module_display_optional_field_2'])
				$this->body .="<td   class=featured_4_optional_header_2 nowrap>".urldecode($this->messages[1010])."</font></td>\n\t";
			if ($show_module['module_display_optional_field_3'])
				$this->body .="<td   class=featured_4_optional_header_3 nowrap>".urldecode($this->messages[1011])."</font></td>\n\t";
			if ($show_module['module_display_optional_field_4'])
				$this->body .="<td   class=featured_4_optional_header_4 nowrap>".urldecode($this->messages[1012])."</font></td>\n\t";
			if ($show_module['module_display_optional_field_5'])
				$this->body .="<td   class=featured_4_optional_header_5 nowrap>".urldecode($this->messages[1013])."</font></td>\n\t";
			if ($show_module['module_display_optional_field_6'])
				$this->body .="<td   class=featured_4_optional_header_6 nowrap>".urldecode($this->messages[1014])."</font></td>\n\t";
			if ($show_module['module_display_optional_field_7'])
				$this->body .="<td   class=featured_4_optional_header_7 nowrap>".urldecode($this->messages[1015])."</font></td>\n\t";
			if ($show_module['module_display_optional_field_8'])
				$this->body .="<td   class=featured_4_optional_header_8 nowrap>".urldecode($this->messages[1016])."</font></td>\n\t";
			if ($show_module['module_display_optional_field_9'])
				$this->body .="<td   class=featured_4_optional_header_9 nowrap>".urldecode($this->messages[1017])."</font></td>\n\t";
			if ($show_module['module_display_optional_field_10'])
				$this->body .="<td   class=featured_4_optional_header_10 nowrap>".urldecode($this->messages[1018])."</font></td>\n\t";
			if ($show_module['module_display_optional_field_11'])
				$this->body .="<td   class=featured_4_optional_header_11 nowrap>".urldecode($this->messages[1766])."</font></td>\n\t";
			if ($show_module['module_display_optional_field_12'])
				$this->body .="<td   class=featured_4_optional_header_12 nowrap>".urldecode($this->messages[1767])."</font></td>\n\t";
			if ($show_module['module_display_optional_field_13'])
				$this->body .="<td   class=featured_4_optional_header_13 nowrap>".urldecode($this->messages[1768])."</font></td>\n\t";
			if ($show_module['module_display_optional_field_14'])
				$this->body .="<td   class=featured_4_optional_header_14 nowrap>".urldecode($this->messages[1769])."</font></td>\n\t";
			if ($show_module['module_display_optional_field_15'])
				$this->body .="<td   class=featured_4_optional_header_15 nowrap>".urldecode($this->messages[1770])."</font></td>\n\t";
			if ($show_module['module_display_optional_field_16'])
				$this->body .="<td   class=featured_4_optional_header_16 nowrap>".urldecode($this->messages[1771])."</font></td>\n\t";
			if ($show_module['module_display_optional_field_17'])
				$this->body .="<td   class=featured_4_optional_header_17 nowrap>".urldecode($this->messages[1772])."</font></td>\n\t";
			if ($show_module['module_display_optional_field_18'])
				$this->body .="<td   class=featured_4_optional_header_18 nowrap>".urldecode($this->messages[1773])."</font></td>\n\t";
			if ($show_module['module_display_optional_field_19'])
				$this->body .="<td   class=featured_4_optional_header_19 nowrap>".urldecode($this->messages[1774])."</font></td>\n\t";
			if ($show_module['module_display_optional_field_20'])
				$this->body .="<td   class=featured_4_optional_header_20 nowrap>".urldecode($this->messages[1775])."</font></td>\n\t";
			if ($show_module['module_display_city'])
				$this->body .="<td  class=featured_4_city_header nowrap>".urldecode($this->messages[1382])."</td>\n\t";
			if ($show_module['module_display_state'])
				$this->body .="<td class=featured_4_state_header nowrap>".urldecode($this->messages[1383])."</td>\n\t";
			if ($show_module['module_display_country'])
				$this->body .="<td class=featured_4_country_header nowrap>".urldecode($this->messages[1384])."</td>\n\t";
			if ($show_module['module_display_zip'])
				$this->body .="<td class=featured_4_zip_header nowrap>".urldecode($this->messages[1385])."</td>\n\t";

			//CLASSAUCTIONS and AUCTIONS SPECIFIC
			if ($show_module['module_display_number_bids'])
			{
				$this->body .="<td class=featured_4_num_bids_td nowrap>".urldecode($this->messages[102571])."</td>\n\t";
			}

			if ($show_module['module_display_price'])
				$this->body .="<td  class=featured_4_price_td  nowrap>".urldecode($this->messages[697])."</td>\n\t";
			if ($show_module['module_display_entry_date'])
				$this->body .="<td  class=featured_4_entry_td nowrap>".urldecode($this->messages[698])."</td>\n\t";

			//CLASSAUCTIONS and AUCTIONS SPECIFIC
			if ($show_module['module_display_time_left'])
			{
				$this->body .="<td class=featured_4_time_left_header nowrap>".urldecode($this->messages[102572])."</td>\n\t";
			}
		...
		while ($show_classifieds = $featured_result->FetchRow())
		{
			if (($this->row_count % 2) == 0)
			{
				if ($show_classifieds['bolding'])
					$css_class_tag= "featured_4_result_table_body_even_bold";
				else
					$css_class_tag=  "featured_4_result_table_body_even ";
			}
			else
			{
				if ($show_classifieds['bolding'])
					$css_class_tag=  "featured_4_result_table_body_odd_bold";
				else
					$css_class_tag=  "featured_4_result_table_body_odd ";
			}
			...
			if ($show_module['module_display_listing_column'])
			{
				...
				{
					$this->body .=urldecode($this->messages[200059]);
				}
				if ($show_classifieds['item_type'] == 2)
				{
					$this->body .=urldecode($this->messages[200060]);
				}
			...
			*/
			...
			if ($show_module['module_display_time_left'])
			{
				...
				if ($weeks > 0)
				{
					$this->body .= $weeks." ".stripslashes(urldecode($this->messages[102578])).", ".$days." ".stripslashes(urldecode($this->messages[102579]));
				}
				elseif ($days > 0)
				{
					$this->body .= $days." ".stripslashes(urldecode($this->messages[102579])).", ".$hours." ".stripslashes(urldecode($this->messages[102580]));
				}
				elseif ($hours > 0)
				{
					$this->body .= $hours." ".stripslashes(urldecode($this->messages[102580])).", ".$minutes." ".stripslashes(urldecode($this->messages[102581]));
				}
				elseif ($minutes > 0)
				{
					$this->body .= $minutes." ".stripslashes(urldecode($this->messages[102581])).", ".$seconds." ".stripslashes(urldecode($this->messages[102582]));
				}
				elseif ($seconds > 0)
				{
					$this->body .= $seconds." ".stripslashes(urldecode($this->messages[102582]));
				}
