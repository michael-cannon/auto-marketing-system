...
var monthNames = ['January', 'February', 'March', 'April', 'May', 'June', 'July', 'Augost', 'September', 'October', 'November', 'December'];
var monthNamesR = ['January', 'February', 'March', 'April', 'May', 'June', 'July', 'Augost', 'September', 'October', 'November', 'December'];
...
for (var i = 1; i < 33; i++)
{
	...
	{
		if (isThisMonth && currDate.getDate() == i) calendarHTML += '<td class="calFont" style="color: #ffffff;" bgcolor="#ff7f00"><small>' + i + '</small><\/td>';
