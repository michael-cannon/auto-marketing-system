...
elseif ($featured_result->RecordCount() > 0)
{
	...
	if ($featured_result->RecordCount() > 0)
	{
		...
		$this->body .="<tr class=featured_ad_pics_1_header_row_level_4><td colspan=".$show_module['module_number_of_columns'].">
				".urldecode($this->messages[2254])."</td></tr>\n\t";
		...
		while ($show = $featured_result->FetchRow())
		{
			...
			{
				$this->body .="<tr class=featured_ad_pics_1_pic_row_level_4><td width=".$column_width." valign=top>";
				...
				{
					$this->body .= "</td></tr>";
					$this->body .= "<tr><td class=featured_ad_pics_1_pic_row_level_4>";
				}
				...
				if($this->is_class_auctions())
				{
					...
					{
						$this->body .= "<br>";
						$this->body .= urldecode($this->messages[200041]);
					...
					{
						$this->body .= "<br>";
						$this->body .= urldecode($this->messages[200042]);
