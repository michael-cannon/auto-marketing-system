...
$this->sql_query = "select * from geodesic_classifieds where featured_ad_3 = 1 and live = 1 ".$this->sql_zip_filter_in_statement.$this->sql_state_filter_statement.$sql_filter_in_statement.$type_in_statement;
...
elseif ($featured_result->RecordCount() > 0)
{
	...
	//$result->Move(0);
	//$this->display_featured_2_level_3_result($db,$featured_result);
	if ($featured_result->RecordCount() > 0)
	{
		...
		{
			$this->body .="<tr class=featured_2_level_3_title_row>\n\t\t";
			$colspan = 1;
			...
			if ($show_module['module_display_time_left'])
				$colspan++;
			$this->body .= "<td colspan=".$colspan.">".urldecode($this->messages[2072])."</td>\n";
			$this->body .="</tr>\n\t";
		}
		$this->body .="<tr>\n\t\t";
		if ($show_module['module_display_header_row'])
		{
			...
			if ($show_module['module_display_listing_column'])
			{
				$this->body .="<td class=featured_2_level_3_type nowrap>".urldecode($this->messages[200079])."</td>\n\t";
			}

			if ($show_module['module_display_photo_icon'])
			{
				$this->body .="<td  class=featured_2_level_3_photo_td nowrap>".urldecode($this->messages[2073])."</td>\n\t";
			}
			// 0 is default condition
			if (!$show_module['module_display_title'])
			{
				$this->body .="<td  class=featured_2_level_3_title_td ";
				if ((($show_module['module_display_ad_description'])&& ($show_module['module_display_ad_description_where'])) || (!$show_module['module_display_ad_description']))
					$this->body .= "width=100%";				
				$this->body .=">".urldecode($this->messages[2074]);
				if (($show_module['module_display_ad_description']) && ($show_module['module_display_ad_description_where']))
				{
					$this->body .="<br>".urldecode($this->messages[2075]);
				}
				$this->body .="</td>\n\t\t";
			}
			if (($show_module['module_display_ad_description']) && (!$show_module['module_display_ad_description_where']))
			{
				$this->body .="<td   class=featured_2_level_3_description_td>".urldecode($this->messages[2075])."</td>\n\t";
			}
			if ($show_module['module_display_optional_field_1'])
				$this->body .="<td   class=featured_2_level_3_optional_header_1 nowrap>".urldecode($this->messages[2078])."</font></td>\n\t";
			if ($show_module['module_display_optional_field_2'])
				$this->body .="<td   class=featured_2_level_3_optional_header_2 nowrap>".urldecode($this->messages[2079])."</font></td>\n\t";
			if ($show_module['module_display_optional_field_3'])
				$this->body .="<td   class=featured_2_level_3_optional_header_3 nowrap>".urldecode($this->messages[2080])."</font></td>\n\t";
			if ($show_module['module_display_optional_field_4'])
				$this->body .="<td   class=featured_2_level_3_optional_header_4 nowrap>".urldecode($this->messages[2081])."</font></td>\n\t";
			if ($show_module['module_display_optional_field_5'])
				$this->body .="<td   class=featured_2_level_3_optional_header_5 nowrap>".urldecode($this->messages[2082])."</font></td>\n\t";
			if ($show_module['module_display_optional_field_6'])
				$this->body .="<td   class=featured_2_level_3_optional_header_6 nowrap>".urldecode($this->messages[2083])."</font></td>\n\t";
			if ($show_module['module_display_optional_field_7'])
				$this->body .="<td   class=featured_2_level_3_optional_header_7 nowrap>".urldecode($this->messages[2084])."</font></td>\n\t";
			if ($show_module['module_display_optional_field_8'])
				$this->body .="<td   class=featured_2_level_3_optional_header_8 nowrap>".urldecode($this->messages[2085])."</font></td>\n\t";
			if ($show_module['module_display_optional_field_9'])
				$this->body .="<td   class=featured_2_level_3_optional_header_9 nowrap>".urldecode($this->messages[2086])."</font></td>\n\t";
			if ($show_module['module_display_optional_field_10'])
				$this->body .="<td   class=featured_2_level_3_optional_header_10 nowrap>".urldecode($this->messages[2087])."</font></td>\n\t";
			if ($show_module['module_display_optional_field_11'])
				$this->body .="<td   class=featured_2_level_3_optional_header_11 nowrap>".urldecode($this->messages[2088])."</font></td>\n\t";
			if ($show_module['module_display_optional_field_12'])
				$this->body .="<td   class=featured_2_level_3_optional_header_12 nowrap>".urldecode($this->messages[2089])."</font></td>\n\t";
			if ($show_module['module_display_optional_field_13'])
				$this->body .="<td   class=featured_2_level_3_optional_header_13 nowrap>".urldecode($this->messages[2090])."</font></td>\n\t";
			if ($show_module['module_display_optional_field_14'])
				$this->body .="<td   class=featured_2_level_3_optional_header_14 nowrap>".urldecode($this->messages[2091])."</font></td>\n\t";
			if ($show_module['module_display_optional_field_15'])
				$this->body .="<td   class=featured_2_level_3_optional_header_15 nowrap>".urldecode($this->messages[2092])."</font></td>\n\t";
			if ($show_module['module_display_optional_field_16'])
				$this->body .="<td   class=featured_2_level_3_optional_header_16 nowrap>".urldecode($this->messages[2093])."</font></td>\n\t";
			if ($show_module['module_display_optional_field_17'])
				$this->body .="<td   class=featured_2_level_3_optional_header_17 nowrap>".urldecode($this->messages[2094])."</font></td>\n\t";
			if ($show_module['module_display_optional_field_18'])
				$this->body .="<td   class=featured_2_level_3_optional_header_18 nowrap>".urldecode($this->messages[2095])."</font></td>\n\t";
			if ($show_module['module_display_optional_field_19'])
				$this->body .="<td   class=featured_2_level_3_optional_header_19 nowrap>".urldecode($this->messages[2096])."</font></td>\n\t";
			if ($show_module['module_display_optional_field_20'])
				$this->body .="<td   class=featured_2_level_3_optional_header_20 nowrap>".urldecode($this->messages[2097])."</font></td>\n\t";
			if ($show_module['module_display_city'])
				$this->body .="<td  class=featured_2_level_3_city_header nowrap>".urldecode($this->messages[2098])."</td>\n\t";
			if ($show_module['module_display_state'])
				$this->body .="<td class=featured_2_level_3_state_header nowrap>".urldecode($this->messages[2099])."</td>\n\t";
			if ($show_module['module_display_country'])
				$this->body .="<td class=featured_2_level_3_country_header nowrap>".urldecode($this->messages[2100])."</td>\n\t";
			if ($show_module['module_display_zip'])
				$this->body .="<td class=featured_2_level_3_zip_header nowrap>".urldecode($this->messages[2101])."</td>\n\t";

			//CLASSAUCTIONS and AUCTIONS SPECIFIC
			if ($show_module['module_display_number_bids'])
			{
				$this->body .="<td class=featured_2_level_3_number_bids nowrap>".urldecode($this->messages[102641])."</td>\n\t";
			}

			if ($show_module['module_display_price'])
				$this->body .="<td  class=featured_2_level_3_price_td  nowrap>".urldecode($this->messages[2076])."</td>\n\t";
			if ($show_module['module_display_entry_date'])
				$this->body .="<td  class=featured_2_level_3_entry_td nowrap>".urldecode($this->messages[2077])."</td>\n\t";

			//CLASSAUCTIONS and AUCTIONS SPECIFIC
			if ($show_module['module_display_time_left'])
			{
				$this->body .="<td class=featured_2_level_3_time_left nowrap>".urldecode($this->messages[102642])."</td>\n\t";
			}
		...
		while ($show_classifieds = $featured_result->FetchRow())
		{
			if (($this->row_count % 2) == 0)
			{
				if ($show_classifieds['bolding'])
					$css_class_tag= "featured_2_level_3_result_table_body_even_bold";
				else
					$css_class_tag=  "featured_2_level_3_result_table_body_even ";
			}
			else
			{
				if ($show_classifieds['bolding'])
					$css_class_tag=  "featured_2_level_3_result_table_body_odd_bold";
				else
					$css_class_tag=  "featured_2_level_3_result_table_body_odd ";
			}
			...
			if ($show_module['module_display_listing_column'])
			{
				...
				{
					$this->body .=urldecode($this->messages[200080]);
				}
				if ($show_classifieds['item_type'] == 2)
				{
					$this->body .=urldecode($this->messages[200081]);
				}
			...
			*/
			...
			if ($show_module['module_display_time_left'])
			{
				...
				if ($weeks > 0)
				{
					$this->body .= $weeks." ".stripslashes(urldecode($this->messages[102647])).", ".$days." ".stripslashes(urldecode($this->messages[102649]));
				}
				elseif ($days > 0)
				{
					$this->body .= $days." ".stripslashes(urldecode($this->messages[102649])).", ".$hours." ".stripslashes(urldecode($this->messages[102650]));
				}
				elseif ($hours > 0)
				{
					$this->body .= $hours." ".stripslashes(urldecode($this->messages[102650])).", ".$minutes." ".stripslashes(urldecode($this->messages[102651]));
				}
				elseif ($minutes > 0)
				{
					$this->body .= $minutes." ".stripslashes(urldecode($this->messages[102651])).", ".$seconds." ".stripslashes(urldecode($this->messages[102652]));
				}
				elseif ($seconds > 0)
				{
					$this->body .= $seconds." ".stripslashes(urldecode($this->messages[102652]));
				}
