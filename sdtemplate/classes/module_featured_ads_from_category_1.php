<? //module_featured_ads_from_category_1.php
/**************************************************************************\
...
{
	$this->get_sql_in_statement($db,$show_module['module_category']);
}
else
{
	...
	if ($featured_result->RecordCount() > 0)
	{
		...
		if ($show_module['module_display_header_row'])
		{
			...
			if ($show_module['module_display_time_left'])
				$colspan++;
			$this->body .= "<td colspan=".$colspan.">".urldecode($this->messages[2379])."</td>\n";
			$this->body .="</tr>\n\t";
		}
		$this->body .="<tr>\n\t\t";
		if ($show_module['module_display_header_row'])
		{
			...
			if ($show_module['module_display_listing_column'])
			{
				$this->body .="<td class=featured_6_type nowrap>".urldecode($this->messages[200064])."</td>\n\t";
			}

			if ($show_module['module_display_photo_icon'])
			{
				$this->body .="<td  class=featured_category_1_photo_td nowrap>".urldecode($this->messages[2351])."</td>\n\t";
			}
			// 0 is default condition
			if (!$show_module['module_display_title'])
			{
				$this->body .="<td  class=featured_category_1_title_td ";
				if ((($show_module['module_display_ad_description'])&& ($show_module['module_display_ad_description_where'])) || (!$show_module['module_display_ad_description']))
					$this->body .= "width=100%";					
				$this->body .=">".urldecode($this->messages[2360]);
				if (($show_module['module_display_ad_description']) && ($show_module['module_display_ad_description_where']))
					$this->body .="<br>".urldecode($this->messages[2352]);
				$this->body .="</td>\n\t\t";
			}
			if (($show_module['module_display_ad_description']) && (!$show_module['module_display_ad_description_where']))
				$this->body .="<td   class=featured_category_1_description_td>".urldecode($this->messages[2352])."</td>\n\t";
			if ($show_module['module_display_optional_field_1'])
				$this->body .="<td   class=featured_category_1_optional_header_1 nowrap>".urldecode($this->messages[2353])."</font></td>\n\t";
			if ($show_module['module_display_optional_field_2'])
				$this->body .="<td   class=featured_category_1_optional_header_2 nowrap>".urldecode($this->messages[2354])."</font></td>\n\t";
			if ($show_module['module_display_optional_field_3'])
				$this->body .="<td   class=featured_category_1_optional_header_3 nowrap>".urldecode($this->messages[2355])."</font></td>\n\t";
			if ($show_module['module_display_optional_field_4'])
				$this->body .="<td   class=featured_category_1_optional_header_4 nowrap>".urldecode($this->messages[2356])."</font></td>\n\t";
			if ($show_module['module_display_optional_field_5'])
				$this->body .="<td   class=featured_category_1_optional_header_5 nowrap>".urldecode($this->messages[2357])."</font></td>\n\t";
			if ($show_module['module_display_optional_field_6'])
				$this->body .="<td   class=featured_category_1_optional_header_6 nowrap>".urldecode($this->messages[2358])."</font></td>\n\t";
			if ($show_module['module_display_optional_field_7'])
				$this->body .="<td   class=featured_category_1_optional_header_7 nowrap>".urldecode($this->messages[2359])."</font></td>\n\t";
			if ($show_module['module_display_optional_field_8'])
				$this->body .="<td   class=featured_category_1_optional_header_8 nowrap>".urldecode($this->messages[2360])."</font></td>\n\t";
			if ($show_module['module_display_optional_field_9'])
				$this->body .="<td   class=featured_category_1_optional_header_9 nowrap>".urldecode($this->messages[2361])."</font></td>\n\t";
			if ($show_module['module_display_optional_field_10'])
				$this->body .="<td   class=featured_category_1_optional_header_10 nowrap>".urldecode($this->messages[2362])."</font></td>\n\t";
			if ($show_module['module_display_optional_field_11'])
				$this->body .="<td   class=featured_category_1_optional_header_11 nowrap>".urldecode($this->messages[2363])."</font></td>\n\t";
			if ($show_module['module_display_optional_field_12'])
				$this->body .="<td   class=featured_category_1_optional_header_12 nowrap>".urldecode($this->messages[2364])."</font></td>\n\t";
			if ($show_module['module_display_optional_field_13'])
				$this->body .="<td   class=featured_category_1_optional_header_13 nowrap>".urldecode($this->messages[2365])."</font></td>\n\t";
			if ($show_module['module_display_optional_field_14'])
				$this->body .="<td   class=featured_category_1_optional_header_14 nowrap>".urldecode($this->messages[2366])."</font></td>\n\t";
			if ($show_module['module_display_optional_field_15'])
				$this->body .="<td   class=featured_category_1_optional_header_15 nowrap>".urldecode($this->messages[2367])."</font></td>\n\t";
			if ($show_module['module_display_optional_field_16'])
				$this->body .="<td   class=featured_category_1_optional_header_16 nowrap>".urldecode($this->messages[2368])."</font></td>\n\t";
			if ($show_module['module_display_optional_field_17'])
				$this->body .="<td   class=featured_category_1_optional_header_17 nowrap>".urldecode($this->messages[2369])."</font></td>\n\t";
			if ($show_module['module_display_optional_field_18'])
				$this->body .="<td   class=featured_category_1_optional_header_18 nowrap>".urldecode($this->messages[2370])."</font></td>\n\t";
			if ($show_module['module_display_optional_field_19'])
				$this->body .="<td   class=featured_category_1_optional_header_19 nowrap>".urldecode($this->messages[2371])."</font></td>\n\t";
			if ($show_module['module_display_optional_field_20'])
				$this->body .="<td   class=featured_category_1_optional_header_20 nowrap>".urldecode($this->messages[2372])."</font></td>\n\t";
			if ($show_module['module_display_city'])
				$this->body .="<td  class=featured_category_1_city_header nowrap>".urldecode($this->messages[2373])."</td>\n\t";
			if ($show_module['module_display_state'])
				$this->body .="<td class=featured_category_1_state_header nowrap>".urldecode($this->messages[2374])."</td>\n\t";
			if ($show_module['module_display_country'])
				$this->body .="<td class=featured_category_1_country_header nowrap>".urldecode($this->messages[2375])."</td>\n\t";
			if ($show_module['module_display_zip'])
				$this->body .="<td class=featured_category_1_zip_header nowrap>".urldecode($this->messages[2376])."</td>\n\t";

			//CLASSAUCTIONS and AUCTIONS SPECIFIC
			if ($show_module['module_display_number_bids'])
			{
				$this->body .="<td class=featured_6_number_bids nowrap>".urldecode($this->messages[102597])."</td>\n\t";
			}

			if ($show_module['module_display_price'])
				$this->body .="<td  class=featured_category_1_price_td  nowrap>".urldecode($this->messages[2377])."</td>\n\t";
			if ($show_module['module_display_entry_date'])
				$this->body .="<td  class=featured_category_1_entry_td nowrap>".urldecode($this->messages[2378])."</td>\n\t";

			//CLASSAUCTIONS and AUCTIONS SPECIFIC
			if ($show_module['module_display_time_left'])
			{
				$this->body .="<td class=featured_6_time_left nowrap>".urldecode($this->messages[102599])."</td>\n\t";
			}
		...
		while ($show_classifieds = $featured_result->FetchRow())
		{
			if (($this->row_count % 2) == 0)
			{
				if ($show_classifieds['bolding'])
					$css_class_tag= "featured_category_1_result_table_body_even_bold";
				else
					$css_class_tag=  "featured_category_1_result_table_body_even ";
			}
			else
			{
				if ($show_classifieds['bolding'])
					$css_class_tag=  "featured_category_1_result_table_body_odd_bold";
				else
					$css_class_tag=  "featured_category_1_result_table_body_odd ";
			}
			...
			if ($show_module['module_display_listing_column'])
			{
				...
				{
					$this->body .=urldecode($this->messages[200065]);
				}
				if ($show_classifieds['item_type'] == 2)
				{
					$this->body .=urldecode($this->messages[200066]);
				}
			...
			*/
			...
			if ($show_module['module_display_time_left'])
			{
				...
				if ($weeks > 0)
				{
					$this->body .= $weeks." ".stripslashes(urldecode($this->messages[102606])).", ".$days." ".stripslashes(urldecode($this->messages[102607]));
				}
				elseif ($days > 0)
				{
					$this->body .= $days." ".stripslashes(urldecode($this->messages[102607])).", ".$hours." ".stripslashes(urldecode($this->messages[102608]));
				}
				elseif ($hours > 0)
				{
					$this->body .= $hours." ".stripslashes(urldecode($this->messages[102608])).", ".$minutes." ".stripslashes(urldecode($this->messages[102609]));
				}
				elseif ($minutes > 0)
				{
					$this->body .= $minutes." ".stripslashes(urldecode($this->messages[102609])).", ".$seconds." ".stripslashes(urldecode($this->messages[102610]));
				}
				elseif ($seconds > 0)
				{
					$this->body .= $seconds." ".stripslashes(urldecode($this->messages[102610]));
				}
