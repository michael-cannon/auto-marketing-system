...
$this->sql_query .= " order by date desc limit ".$show_module['module_number_of_ads_to_display'];$featured_result = $db->Execute($this->sql_query);
...
{
	//$this->display_newest_2_result($db,$featured_result);
	if ($featured_result->RecordCount() > 0)
	{
		...
		{
			$this->body .="<tr class=newest_2_title_row>\n\t\t";
			$colspan = 1;
			...
			if ($show_module['module_display_time_left'])
				$colspan++;
			$this->body .= "<td colspan=".$colspan.">".urldecode($this->messages[1073])."</td>\n";
			$this->body .="</tr>\n\t";
		}
		$this->body .="<tr>\n\t\t";
		if ($show_module['module_display_header_row'])
		{
			...
			if ($show_module['module_display_listing_column'])
			{
				$this->body .="<td class=newest_2_type nowrap>".urldecode($this->messages[200100])."</td>\n\t";
			}

			if ($show_module['module_display_photo_icon'])
			{
				$this->body .="<td  class=newest_2_photo_td>".urldecode($this->messages[1072])."</td>\n\t";
			}
			// 0 is default condition
			if (!$show_module['module_display_title'])
			{
				$this->body .="<td  class=newest_2_title_td ";
				if ((($show_module['module_display_ad_description'])&& ($show_module['module_display_ad_description_where'])) || (!$show_module['module_display_ad_description']))
					$this->body .= "width=100%";				
				$this->body .=">".urldecode($this->messages[1074]);
				if (($show_module['module_display_ad_description']) && ($show_module['module_display_ad_description_where']))
				{
					$this->body .="<br>".urldecode($this->messages[1075]);
				}
				$this->body .="</td>\n\t\t";
			}
			if (($show_module['module_display_ad_description']) && (!$show_module['module_display_ad_description_where']))
			{
				$this->body .="<td   class=newest_2_description_td>".urldecode($this->messages[1075])."</td>\n\t";
			}
			if ($show_module['module_display_optional_field_1'])
				$this->body .="<td   class=newest_2_optional_1 nowrap>".urldecode($this->messages[1039])."</font></td>\n\t";
			if ($show_module['module_display_optional_field_2'])
				$this->body .="<td   class=newest_2_optional_2 nowrap>".urldecode($this->messages[1040])."</font></td>\n\t";
			if ($show_module['module_display_optional_field_3'])
				$this->body .="<td   class=newest_2_optional_3 nowrap>".urldecode($this->messages[1041])."</font></td>\n\t";
			if ($show_module['module_display_optional_field_4'])
				$this->body .="<td   class=newest_2_optional_4 nowrap>".urldecode($this->messages[1042])."</font></td>\n\t";
			if ($show_module['module_display_optional_field_5'])
				$this->body .="<td   class=newest_2_optional_5 nowrap>".urldecode($this->messages[1043])."</font></td>\n\t";
			if ($show_module['module_display_optional_field_6'])
				$this->body .="<td   class=newest_2_optional_6 nowrap>".urldecode($this->messages[1044])."</font></td>\n\t";
			if ($show_module['module_display_optional_field_7'])
				$this->body .="<td   class=newest_2_optional_7 nowrap>".urldecode($this->messages[1045])."</font></td>\n\t";
			if ($show_module['module_display_optional_field_8'])
				$this->body .="<td   class=newest_2_optional_8 nowrap>".urldecode($this->messages[1046])."</font></td>\n\t";
			if ($show_module['module_display_optional_field_9'])
				$this->body .="<td   class=newest_2_optional_9 nowrap>".urldecode($this->messages[1047])."</font></td>\n\t";
			if ($show_module['module_display_optional_field_10'])
				$this->body .="<td   class=newest_2_optional_10 nowrap>".urldecode($this->messages[1048])."</font></td>\n\t";
			if ($show_module['module_display_optional_field_11'])
				$this->body .="<td   class=newest_2_optional_11 nowrap>".urldecode($this->messages[1796])."</font></td>\n\t";
			if ($show_module['module_display_optional_field_12'])
				$this->body .="<td   class=newest_2_optional_12 nowrap>".urldecode($this->messages[1797])."</font></td>\n\t";
			if ($show_module['module_display_optional_field_13'])
				$this->body .="<td   class=newest_2_optional_13 nowrap>".urldecode($this->messages[1798])."</font></td>\n\t";
			if ($show_module['module_display_optional_field_14'])
				$this->body .="<td   class=newest_2_optional_14 nowrap>".urldecode($this->messages[1799])."</font></td>\n\t";
			if ($show_module['module_display_optional_field_15'])
				$this->body .="<td   class=newest_2_optional_15 nowrap>".urldecode($this->messages[1800])."</font></td>\n\t";
			if ($show_module['module_display_optional_field_16'])
				$this->body .="<td   class=newest_2_optional_16 nowrap>".urldecode($this->messages[1801])."</font></td>\n\t";
			if ($show_module['module_display_optional_field_17'])
				$this->body .="<td   class=newest_2_optional_17 nowrap>".urldecode($this->messages[1802])."</font></td>\n\t";
			if ($show_module['module_display_optional_field_18'])
				$this->body .="<td   class=newest_2_optional_18 nowrap>".urldecode($this->messages[1803])."</font></td>\n\t";
			if ($show_module['module_display_optional_field_19'])
				$this->body .="<td   class=newest_2_optional_19 nowrap>".urldecode($this->messages[1804])."</font></td>\n\t";
			if ($show_module['module_display_optional_field_20'])
				$this->body .="<td   class=newest_2_optional_20 nowrap>".urldecode($this->messages[1805])."</font></td>\n\t";
			if ($show_module['module_display_city'])
				$this->body .="<td  class=newest_2_city_header nowrap>".urldecode($this->messages[1394])."</td>\n\t";
			if ($show_module['module_display_state'])
				$this->body .="<td class=newest_2_state_header nowrap>".urldecode($this->messages[1395])."</td>\n\t";
			if ($show_module['module_display_country'])
				$this->body .="<td class=newest_2_country_header nowrap>".urldecode($this->messages[1396])."</td>\n\t";
			if ($show_module['module_display_zip'])
				$this->body .="<td class=newest_2_zip_header nowrap>".urldecode($this->messages[1397])."</td>\n\t";

			//CLASSAUCTIONS and AUCTIONS SPECIFIC
			if ($show_module['module_display_number_bids'])
			{
				$this->body .="<td class=newest_2_bid_header nowrap>".urldecode($this->messages[102653])."</td>\n\t";
			}

			if ($show_module['module_display_price'])
				$this->body .="<td  class=newest_2_price_td  nowrap>".urldecode($this->messages[1076])."</td>\n\t";
			if ($show_module['module_display_entry_date'])
				$this->body .="<td  class=newest_2_entry_td nowrap>".urldecode($this->messages[1077])."</td>\n\t";

			//CLASSAUCTIONS and AUCTIONS SPECIFIC
			if ($show_module['module_display_time_left'])
			{
				$this->body .="<td class=newest_2_time_left_header nowrap>".urldecode($this->messages[102655])."</td>\n\t";
			}
		...
		while ($show_classifieds = $featured_result->FetchRow())
		{
			if (($this->row_count % 2) == 0)
			{
				if ($show_classifieds['bolding'])
					$css_class_tag= "newest_2_result_table_body_even_bold";
				else
					$css_class_tag=  "newest_2_result_table_body_even ";
			}
			else
			{
				if ($show_classifieds['bolding'])
					$css_class_tag=  "newest_2_result_table_body_odd_bold";
				else
					$css_class_tag=  "newest_2_result_table_body_odd ";
			}
			...
			if ($show_module['module_display_listing_column'])
			{
				...
				{
					$this->body .=urldecode($this->messages[200101]);
				}
				if ($show_classifieds['item_type'] == 2)
				{
					$this->body .=urldecode($this->messages[200102]);
				}
			...
			if ($show_module['module_display_time_left'])
			{
				...
				if ($weeks > 0)
				{
					$this->body .= $weeks." ".stripslashes(urldecode($this->messages[102657])).", ".$days." ".stripslashes(urldecode($this->messages[102658]));
				}
				elseif ($days > 0)
				{
					$this->body .= $days." ".stripslashes(urldecode($this->messages[102658])).", ".$hours." ".stripslashes(urldecode($this->messages[102660]));
				}
				elseif ($hours > 0)
				{
					$this->body .= $hours." ".stripslashes(urldecode($this->messages[102660])).", ".$minutes." ".stripslashes(urldecode($this->messages[102662]));
				}
				elseif ($minutes > 0)
				{
					$this->body .= $minutes." ".stripslashes(urldecode($this->messages[102662])).", ".$seconds." ".stripslashes(urldecode($this->messages[102664]));
				}
				elseif ($seconds > 0)
				{
					$this->body .= $seconds." ".stripslashes(urldecode($this->messages[102664]));
				}
