...
elseif ($featured_result->RecordCount() > 0)
{
	...
	//$result->Move(0);
	//$this->display_featured_5_result($db,$featured_result);
	if ($featured_result->RecordCount() > 0)
	{
		...
		{
			$this->body .="<tr class=featured_5_title_row>\n\t\t";
			$colspan = 1;
			...
			if ($show_module['module_display_time_left'])
				$colspan++;
			$this->body .= "<td colspan=".$colspan.">".urldecode($this->messages[705])."</td>\n";
			$this->body .="</tr>\n\t";
		}
		$this->body .="<tr>\n\t\t";
		if ($show_module['module_display_header_row'])
		{
			...
			if ($show_module['module_display_listing_column'])
			{
				$this->body .="<td class=featured_5_type nowrap>".urldecode($this->messages[200061])."</td>\n\t";
			}
			if ($show_module['module_display_photo_icon'])
			{
				$this->body .="<td  class=featured_5_photo_td nowrap>".urldecode($this->messages[700])."</td>\n\t";
			}
			// 0 is default condition
			if (!$show_module['module_display_title'])
			{
				$this->body .="<td  class=featured_5_title_td ";
				if ((($show_module['module_display_ad_description'])&& ($show_module['module_display_ad_description_where'])) || (!$show_module['module_display_ad_description']))
					$this->body .= "width=100%";				
				$this->body .=">".urldecode($this->messages[701]);
				if (($show_module['module_display_ad_description']) && ($show_module['module_display_ad_description_where']))
				{
					$this->body .="<br>".urldecode($this->messages[702]);
				}
				$this->body .="</td>\n\t\t";
			}
			if (($show_module['module_display_ad_description']) && (!$show_module['module_display_ad_description_where']))
			{
				$this->body .="<td   class=featured_5_description_td>".urldecode($this->messages[702])."</td>\n\t";
			}
			if ($show_module['module_display_optional_field_1'])
				$this->body .="<td   class=featured_5_optional_header_1 nowrap>".urldecode($this->messages[1019])."</font></td>\n\t";
			if ($show_module['module_display_optional_field_2'])
				$this->body .="<td   class=featured_5_optional_header_2 nowrap>".urldecode($this->messages[1020])."</font></td>\n\t";
			if ($show_module['module_display_optional_field_3'])
				$this->body .="<td   class=featured_5_optional_header_3 nowrap>".urldecode($this->messages[1021])."</font></td>\n\t";
			if ($show_module['module_display_optional_field_4'])
				$this->body .="<td   class=featured_5_optional_header_4 nowrap>".urldecode($this->messages[1022])."</font></td>\n\t";
			if ($show_module['module_display_optional_field_5'])
				$this->body .="<td   class=featured_5_optional_header_5 nowrap>".urldecode($this->messages[1023])."</font></td>\n\t";
			if ($show_module['module_display_optional_field_6'])
				$this->body .="<td   class=featured_5_optional_header_6 nowrap>".urldecode($this->messages[1024])."</font></td>\n\t";
			if ($show_module['module_display_optional_field_7'])
				$this->body .="<td   class=featured_5_optional_header_7 nowrap>".urldecode($this->messages[1025])."</font></td>\n\t";
			if ($show_module['module_display_optional_field_8'])
				$this->body .="<td   class=featured_5_optional_header_8 nowrap>".urldecode($this->messages[1026])."</font></td>\n\t";
			if ($show_module['module_display_optional_field_9'])
				$this->body .="<td   class=featured_5_optional_header_9 nowrap>".urldecode($this->messages[1027])."</font></td>\n\t";
			if ($show_module['module_display_optional_field_10'])
				$this->body .="<td   class=featured_5_optional_header_10 nowrap>".urldecode($this->messages[1028])."</font></td>\n\t";
			if ($show_module['module_display_optional_field_11'])
				$this->body .="<td   class=featured_5_optional_header_11 nowrap>".urldecode($this->messages[1776])."</font></td>\n\t";
			if ($show_module['module_display_optional_field_12'])
				$this->body .="<td   class=featured_5_optional_header_12 nowrap>".urldecode($this->messages[1777])."</font></td>\n\t";
			if ($show_module['module_display_optional_field_13'])
				$this->body .="<td   class=featured_5_optional_header_13 nowrap>".urldecode($this->messages[1778])."</font></td>\n\t";
			if ($show_module['module_display_optional_field_14'])
				$this->body .="<td   class=featured_5_optional_header_14 nowrap>".urldecode($this->messages[1779])."</font></td>\n\t";
			if ($show_module['module_display_optional_field_15'])
				$this->body .="<td   class=featured_5_optional_header_15 nowrap>".urldecode($this->messages[1780])."</font></td>\n\t";
			if ($show_module['module_display_optional_field_16'])
				$this->body .="<td   class=featured_5_optional_header_16 nowrap>".urldecode($this->messages[1781])."</font></td>\n\t";
			if ($show_module['module_display_optional_field_17'])
				$this->body .="<td   class=featured_5_optional_header_17 nowrap>".urldecode($this->messages[1782])."</font></td>\n\t";
			if ($show_module['module_display_optional_field_18'])
				$this->body .="<td   class=featured_5_optional_header_18 nowrap>".urldecode($this->messages[1783])."</font></td>\n\t";
			if ($show_module['module_display_optional_field_19'])
				$this->body .="<td   class=featured_5_optional_header_19 nowrap>".urldecode($this->messages[1784])."</font></td>\n\t";
			if ($show_module['module_display_optional_field_20'])
				$this->body .="<td   class=featured_5_optional_header_20 nowrap>".urldecode($this->messages[1785])."</font></td>\n\t";
			if ($show_module['module_display_city'])
				$this->body .="<td  class=featured_5_city_header nowrap>".urldecode($this->messages[1386])."</td>\n\t";
			if ($show_module['module_display_state'])
				$this->body .="<td class=featured_5_state_header nowrap>".urldecode($this->messages[1387])."</td>\n\t";
			if ($show_module['module_display_country'])
				$this->body .="<td class=featured_5_country_header nowrap>".urldecode($this->messages[1388])."</td>\n\t";
			if ($show_module['module_display_zip'])
				$this->body .="<td class=featured_5_zip_header nowrap>".urldecode($this->messages[1389])."</td>\n\t";

			//CLASSAUCTIONS and AUCTIONS SPECIFIC
			if ($show_module['module_display_number_bids'])
			{
				$this->body .="<td class=featured_5_num_bids_td nowrap>".urldecode($this->messages[102583])."</td>\n\t";
			}

			if ($show_module['module_display_price'])
				$this->body .="<td  class=featured_5_price_td  nowrap>".urldecode($this->messages[703])."</td>\n\t";
			if ($show_module['module_display_entry_date'])
				$this->body .="<td  class=featured_5_entry_td nowrap>".urldecode($this->messages[704])."</td>\n\t";

			//CLASSAUCTIONS and AUCTIONS SPECIFIC
			if ($show_module['module_display_time_left'])
			{
				$this->body .="<td class=featured_5_time_left_header nowrap>".urldecode($this->messages[102584])."</td>\n\t";
			}
		...
		while ($show_classifieds = $featured_result->FetchRow())
		{
			if (($this->row_count % 2) == 0)
			{
				if ($show_classifieds['bolding'])
					$css_class_tag= "featured_5_result_table_body_even_bold";
				else
					$css_class_tag=  "featured_5_result_table_body_even ";
			}
			else
			{
				if ($show_classifieds['bolding'])
					$css_class_tag=  "featured_5_result_table_body_odd_bold";
				else
					$css_class_tag=  "featured_5_result_table_body_odd ";
			}
			...
			if ($show_module['module_display_listing_column'])
			{
				...
				{
					$this->body .=urldecode($this->messages[200062]);
				}
				if ($show_classifieds['item_type'] == 2)
				{
					$this->body .=urldecode($this->messages[200063]);
				}
			...
			*/
			...
			if ($show_module['module_display_time_left'])
			{
				...
				if ($weeks > 0)
				{
					$this->body .= $weeks." ".stripslashes(urldecode($this->messages[102587])).", ".$days." ".stripslashes(urldecode($this->messages[102588]));
				}
				elseif ($days > 0)
				{
					$this->body .= $days." ".stripslashes(urldecode($this->messages[102588])).", ".$hours." ".stripslashes(urldecode($this->messages[102591]));
				}
				elseif ($hours > 0)
				{
					$this->body .= $hours." ".stripslashes(urldecode($this->messages[102591])).", ".$minutes." ".stripslashes(urldecode($this->messages[102593]));
				}
				elseif ($minutes > 0)
				{
					$this->body .= $minutes." ".stripslashes(urldecode($this->messages[102593])).", ".$seconds." ".stripslashes(urldecode($this->messages[102596]));
				}
				elseif ($seconds > 0)
				{
					$this->body .= $seconds." ".stripslashes(urldecode($this->messages[102596]));
				}
